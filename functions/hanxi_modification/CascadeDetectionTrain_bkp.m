...
% Last Revision: Sunday 06/03/2016 01:37.

function detect_model = CascadeDetectionTrain(prior_score, ...
                                        label, deep_fea, method)

    r = 0.98; % Pass r positive samples to the next detector.
    score_thre = CalcScoreThre(r, label, prior_score);
    pass_idx = prior_score > score_thre;
    ...
    case 'svm'
        ...
        svm_model = SVMTrain(double(label(:)), ...
                    sparse(double(deep_fea')), n_cross);
    case 'rf'

function script_faster_rcnn_carback_ZFHalf()
...
% addpath('/media/hanxi/m2_SSD/Kitti/');
%% -------------------- CONFIG --------------------
...
%% ----------------- Reduce Class ----------------
carback_data = load('/media/hanxi/m2_SSD/Kitti/voc_format_dataset/carback_voc_data_r80.mat');

...
model_dir                   = fullfile(pwd, 'output', 'faster_rcnn_final', 'faster_rcnn_carback_ZF'); %% ZF
...
%% -------------------- TESTING --------------------
im_names = {'000966.jpg', '000997.jpg', '001174.jpg', '001176.jpg', '001177.jpg', ...
                    'gz-0119-1129-cloudy 013.jpg', 'gz-0119-1129-cloudy 050.jpg', 'gz-0119-1129-cloudy 064.jpg', ...
            'gz-0119-1129-cloudy 028.jpg'}; % {'001763.jpg', '004545.jpg', '000542.jpg', '000456.jpg', '001150.jpg'};
% these images can be downloaded with fetch_faster_rcnn_final_model.m

running_time = [];
save_path = './experiments/res/';
if ~exist(save_path, 'dir'); mkdir(save_path); end
for j = 1:length(im_names)

    im = imread(fullfile('./TestImages/', im_names{j}));
    ...
    pause(0.1);
    save_name = [save_path, im_names{j}];
    saveas(1, save_name);
end
fprintf('mean time: %.3fs\n', mean(running_time(2 : end)));

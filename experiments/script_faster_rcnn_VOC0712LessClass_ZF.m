function script_faster_rcnn_VOC0712LessClass_ZF()
...
% cache base
cache_base_proposal         = 'faster_rcnn_VOC0712LessClass_ZF';
...
[dataset.imdb_train, dataset.roidb_train] = ShrinkClass(dataset.imdb_train, dataset.roidb_train, class_remain);
[imdb_test, roidb_test] = ShrinkClass({dataset.imdb_test}, {dataset.roidb_test}, class_remain);
dataset.imdb_test = imdb_test{1};
dataset.roidb_test = roidb_test{1};

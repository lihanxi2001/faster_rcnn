...
%% -------------------- TESTING --------------------
im_names = {'000456.jpg', '001150.jpg', '000542.jpg', '004545.jpg', '001763.jpg'}; % , '000542.jpg', '000456.jpg', '001150.jpg'};
...
for j = 1:length(im_names)
    ...
    save_name = regexprep(fullfile(pwd, im_names{j}), '\.jpg', '\.mat');
